package com.example.roomdb_yanuar_21
...
import com.example.roomdb_yanuar_21.room.Constant
import com.example.roomdb_yanuar_21.room.Note
import com.example.roomdb_yanuar_21.room.NoteDB
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onStart() {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            val movies = db.noteDao().getNotes()
